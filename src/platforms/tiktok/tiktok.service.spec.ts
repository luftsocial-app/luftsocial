...
describe('TikTokService', () => {
  ...
  describe('initializeVideoUpload', () => {
    ...
    it('should initialize video upload with URL', async () => {
      const mockResponse = {
        data: {
          error: { code: 'ok' },
          data: {
      ...
      const result = await service.initializeVideoUpload(
        mockAccountId,
      ...
      expect(mockedAxios.post).toHaveBeenCalledWith(
        `${mockBaseUrl}/post/publish/video/init/`,
        {
          post_info: {
            title: mockCreateVideoParams.title,
            privacy_level: mockCreateVideoParams.privacyLevel,
            disable_duet: mockCreateVideoParams.disableDuet,
            disable_stitch: mockCreateVideoParams.disableStitch,
            disable_comment: mockCreateVideoParams.disableComment,
            video_cover_timestamp_ms:
              mockCreateVideoParams.videoCoverTimestampMs,
            brand_content_toggle: mockCreateVideoParams.brandContentToggle,
            brand_organic_toggle: mockCreateVideoParams.brandOrganicToggle,
            is_aigc: mockCreateVideoParams.isAigc,
          },
          source_info: {
            source: 'PULL_FROM_URL',
      ...
      expect(tiktokRepo.createVideo).toHaveBeenCalled();
    ...
    it('should initialize video upload with file upload', async () => {
      const mockResponse = {
        data: {
          error: { code: 'ok' },
          data: {
