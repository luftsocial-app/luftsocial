...
export class Migrations1742919185244 implements MigrationInterface {
  name = 'Migrations1742919185244';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tbl_role" ("id" SERIAL NOT NULL, "name" "public"."tbl_role_name_enum" NOT NULL DEFAULT 'member', "description" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7fb8c467d6259854a09dd60c109" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tbl_user_tenants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "userId" uuid, "tenantId" uuid, CONSTRAINT "PK_3a67009cbd1b0f96e77286e3400" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "conversation_participants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "tenant_id" character varying NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "conversation_id" uuid NOT NULL, "user_id" uuid NOT NULL, "role" "public"."conversation_participants_role_enum" NOT NULL DEFAULT 'member', "status" "public"."conversation_participants_status_enum" NOT NULL DEFAULT 'member', "last_active_at" TIMESTAMP NOT NULL DEFAULT now(), "settings" jsonb NOT NULL DEFAULT '{}', CONSTRAINT "PK_61b51428ad9453f5921369fbe94" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "tenant_id" character varying NOT NULL, "deleted_at" TIMESTAMP WITH TIME ZONE, "content" text NOT NULL, "conversation_id" uuid NOT NULL, "sender_id" uuid NOT NULL, "type" "public"."messages_type_enum" NOT NULL DEFAULT 'text', "is_edited" boolean NOT NULL DEFAULT false, "is_deleted" boolean NOT NULL DEFAULT false, "is_pinned" boolean NOT NULL DEFAULT false, "status" "public"."messages_status_enum" NOT NULL DEFAULT 'sending', "deleted_by" character varying, "parent_message_id" uuid, "metadata" jsonb NOT NULL DEFAULT '{}', "reactions" jsonb NOT NULL DEFAULT '[]', "edit_history" jsonb NOT NULL DEFAULT '[]', "read_by" jsonb NOT NULL DEFAULT '{}', CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tbl_notifications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."tbl_notifications_type_enum" NOT NULL, "is_read" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "messageId" uuid, CONSTRAINT "PK_864f5e52afeed73fdfd87ba738b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tbl_posts" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "content" character varying NOT NULL, "tenant_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_95df0a6af5476f1c4b9cc7024f0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "facebook_post_metrics" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "likesCount" integer NOT NULL DEFAULT '0', "commentsCount" integer NOT NULL DEFAULT '0', "sharesCount" integer NOT NULL DEFAULT '0', "reach" integer NOT NULL DEFAULT '0', "impressions" integer NOT NULL DEFAULT '0', "engagementRate" numeric(5,2) NOT NULL DEFAULT '0', "demographicBreakdown" jsonb, "collectedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "accountId" uuid, "postId" uuid, CONSTRAINT "PK_d7aea1f2f56cba80ce61fb75d3d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "facebook_posts" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "postId" character varying NOT NULL, "content" text NOT NULL, "mediaItems" jsonb, "permalinkUrl" character varying, "isPublished" boolean NOT NULL DEFAULT false, "scheduledTime" TIMESTAMP, "publishedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "accountId" uuid, "pageId" uuid, CONSTRAINT "PK_e9981f21016b53fde57297804b5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "facebook_pages" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "pageId" character varying NOT NULL, "name" character varying NOT NULL, "category" character varying, "about" character varying, "description" character varying, "accessToken" character varying NOT NULL, "permissions" jsonb NOT NULL, "followerCount" integer, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "facebookAccountId" uuid, CONSTRAINT "PK_496674684a6f17fd3aee100be28" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "facebook_accounts" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "facebookUserId" character varying NOT NULL, "name" character varying NOT NULL, "email" character varying, "profileUrl" character varying, "permissions" jsonb NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "socialAccountId" uuid, CONSTRAINT "REL_67050365c5f7e2edb4bf508fac" UNIQUE ("socialAccountId"), CONSTRAINT "PK_cbb18301bf0fd763db534dee458" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."social_accounts_platform_enum" AS ENUM('INSTAGRAM', 'FACEBOOK', 'TIKTOK', 'LINKEDIN')`,
    );
    await queryRunner.query(
      `CREATE TABLE "social_accounts" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "platform" "public"."social_accounts_platform_enum" NOT NULL, "platformUserId" character varying NOT NULL, "accessToken" character varying NOT NULL, "refreshToken" character varying, "tokenExpiresAt" TIMESTAMP NOT NULL, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e9e58d2d8e9fafa20af914d9750" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tiktok_accounts" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tiktokUserId" character varying NOT NULL, "username" character varying NOT NULL, "displayName" character varying, "followerCount" integer NOT NULL DEFAULT '0', "followingCount" integer NOT NULL DEFAULT '0', "likesCount" integer NOT NULL DEFAULT '0', "videoCount" integer NOT NULL DEFAULT '0', "avatarUrl" character varying, "isVerified" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "socialAccountId" uuid, CONSTRAINT "REL_0bfcb0414f0bda0a4f2d70f36f" UNIQUE ("socialAccountId"), CONSTRAINT "PK_78bccdf805fea8f9635bfc4127d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tiktok_metrics" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "viewCount" integer NOT NULL DEFAULT '0', "likeCount" integer NOT NULL DEFAULT '0', "commentCount" integer NOT NULL DEFAULT '0', "shareCount" integer NOT NULL DEFAULT '0', "playCount" integer NOT NULL DEFAULT '0', "downloadCount" integer NOT NULL DEFAULT '0', "engagementRate" numeric(5,2) NOT NULL DEFAULT '0', "averageWatchTime" numeric(10,2), "totalWatchTimeMillis" bigint, "retentionRate" jsonb, "audienceTerritories" jsonb, "collectedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "videoId" uuid, CONSTRAINT "PK_39e2f3ade9bb7fb869dbd004145" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tiktok_videos_status_enum" AS ENUM('PENDING', 'UPLOADED', 'PUBLISHED', 'FAILED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "tiktok_videos" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "publishId" character varying NOT NULL, "uploadUrl" character varying, "privacyLevel" integer NOT NULL, "title" character varying, "disableDuet" boolean NOT NULL DEFAULT false, "disableStitch" boolean NOT NULL DEFAULT false, "disableComment" boolean NOT NULL DEFAULT false, "videoCoverTimestampMs" integer, "brandContentToggle" boolean NOT NULL DEFAULT false, "brandOrganicToggle" boolean NOT NULL DEFAULT false, "isAigc" boolean NOT NULL DEFAULT false, "status" "public"."tiktok_videos_status_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "accountId" uuid, CONSTRAINT "PK_4666ba905d93fbc75b5d9ce36b0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "linkedin_accounts" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "linkedinUserId" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying, "profileUrl" character varying, "permissions" jsonb NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "metadata" jsonb, "socialAccountId" uuid, CONSTRAINT "REL_cc2c691eedc005243051f7b9a4" UNIQUE ("socialAccountId"), CONSTRAINT "PK_f86cde0cd40f8aaa11f6d3e57bb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "linkedin_posts" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "postId" character varying NOT NULL, "content" text NOT NULL, "shareUrl" character varying, "mediaItems" jsonb, "thumbnailUrl" character varying, "isPublished" boolean NOT NULL DEFAULT false, "scheduledTime" TIMESTAMP, "publishedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "organizationId" uuid, CONSTRAINT "PK_fd37b64c9af6b96cd0fd1f76a1d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "linkedin_organizations" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "organizationId" character varying NOT NULL, "name" character varying NOT NULL, "vanityName" character varying NOT NULL, "description" character varying NOT NULL, "permissions" jsonb NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "accountId" uuid, CONSTRAINT "PK_0fc5b78e66cd64eacba2804b8ea" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "instagram_metrics" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "likesCount" integer NOT NULL DEFAULT '0', "commentsCount" integer NOT NULL DEFAULT '0', "savesCount" integer NOT NULL DEFAULT '0', "reach" integer NOT NULL DEFAULT '0', "impressions" integer NOT NULL DEFAULT '0', "engagementRate" numeric(5,2) NOT NULL DEFAULT '0', "audienceBreakdown" jsonb, "locationBreakdown" jsonb, "collectedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "mediaId" uuid, CONSTRAINT "PK_2683d0f68656280ae3d55e2ffaa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "instagram_post" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "postId" character varying NOT NULL, "caption" text, "hashtags" jsonb NOT NULL, "mentions" jsonb NOT NULL, "thumbnailUrl" character varying, "mediaItems" jsonb, "permalink" character varying, "isPublished" boolean NOT NULL DEFAULT false, "scheduledTime" TIMESTAMP, "postedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "accountId" uuid, CONSTRAINT "PK_a0946a290d49ebb27c7684b956d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "instagram_accounts" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "instagramAccountId" character varying NOT NULL, "username" character varying NOT NULL, "profileUrl" character varying, "permissions" jsonb NOT NULL, "followerCount" integer NOT NULL DEFAULT '0', "followingCount" integer NOT NULL DEFAULT '0', "mediaCount" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "metadata" jsonb NOT NULL, "socialAccountId" uuid, CONSTRAINT "REL_15fc4ab1f3a8f6abcadad0a4f5" UNIQUE ("socialAccountId"), CONSTRAINT "PK_68884488e846a634585d594d511" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tiktok_upload_sessions" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "publishId" character varying NOT NULL, "uploadUrl" character varying NOT NULL, "uploadParams" jsonb NOT NULL, "status" "public"."tiktok_upload_sessions_status_enum" NOT NULL, "expiresAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "accountId" uuid, CONSTRAINT "PK_b73b09d07cfdf56089ab1f990b2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tiktok_comments" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "platformCommentId" character varying NOT NULL, "content" character varying NOT NULL, "authorId" character varying NOT NULL, "authorUsername" character varying NOT NULL, "likeCount" integer NOT NULL DEFAULT '0', "replyCount" integer NOT NULL DEFAULT '0', "commentedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "videoId" uuid, CONSTRAINT "PK_017658219ec3c44af1081559a1b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "facebook_page_metrics" ("tenantId" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "impressions" integer NOT NULL, "engagedUsers" integer NOT NULL, "newFans" integer NOT NULL, "pageViews" integer NOT NULL, "engagements" integer NOT NULL, "followers" integer NOT NULL, "collectedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "pageId" uuid, CONSTRAINT "PK_a56977bea64f52295fc2a3b3490" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tbl_user_roles" ("role_id" uuid NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_8fe07cf638d5a10cbbadf9d1acd" PRIMARY KEY ("role_id", "user_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_51268e8174fa9c9005e205b3ce" ON "tbl_user_roles" ("role_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3d2485c50c1ddde2ef4b5da79a" ON "tbl_user_roles" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "team_members" ("team_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_1d3c06a8217a8785e2af0ec4ab8" PRIMARY KEY ("team_id", "user_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tbl_users" ADD CONSTRAINT "FK_56d36118ebe11d3e2f2f4220c49" FOREIGN KEY ("activeTenantId") REFERENCES "tbl_tenants"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tbl_user_roles" ADD CONSTRAINT "FK_51268e8174fa9c9005e205b3ce8" FOREIGN KEY ("role_id") REFERENCES "tbl_users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "tbl_user_roles" ADD CONSTRAINT "FK_3d2485c50c1ddde2ef4b5da79a6" FOREIGN KEY ("user_id") REFERENCES "tbl_role"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tbl_user_roles" DROP CONSTRAINT "FK_3d2485c50c1ddde2ef4b5da79a6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tbl_user_roles" DROP CONSTRAINT "FK_51268e8174fa9c9005e205b3ce8"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tbl_users" DROP CONSTRAINT "FK_56d36118ebe11d3e2f2f4220c49"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3d2485c50c1ddde2ef4b5da79a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_51268e8174fa9c9005e205b3ce"`,
    );
