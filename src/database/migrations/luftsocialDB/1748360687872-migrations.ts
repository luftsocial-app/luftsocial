...
export class Migrations1748360687872 implements MigrationInterface {
    name = 'Migrations1748360687872'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_posts" RENAME COLUMN "content" TO "description"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "linkedin_metrics" ADD "industryData" jsonb`);
        await queryRunner.query(`ALTER TABLE "linkedin_metrics" ADD "uniqueImpressions" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "user_posts" RENAME COLUMN "description" TO "content"`);
    }
