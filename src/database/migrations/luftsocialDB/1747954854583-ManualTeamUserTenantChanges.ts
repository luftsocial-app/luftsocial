...
export class ManualTeamUserTenantChanges1747954854583
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "teams" ADD "created_by_user_id" uuid`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "teams" ADD CONSTRAINT "FK_teams_tenant_id_tbl_tenants" FOREIGN KEY ("tenant_id") REFERENCES "tbl_tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    // Add foreign key constraint for teams.created_by_user_id -> tbl_users.id
    // This column is nullable in the entity (createdBy?: User)
    await queryRunner.query(
      `ALTER TABLE "teams" ADD CONSTRAINT "FK_teams_created_by_user_id_tbl_users" FOREIGN KEY ("created_by_user_id") REFERENCES "tbl_users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "teams" DROP CONSTRAINT "FK_teams_created_by_user_id_tbl_users"`,
    );
    // Drop foreign key constraint for teams.tenant_id
    await queryRunner.query(
      `ALTER TABLE "teams" DROP CONSTRAINT "FK_teams_tenant_id_tbl_tenants"`,
    );
