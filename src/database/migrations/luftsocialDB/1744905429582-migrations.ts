...
export class Migrations1744905429582 implements MigrationInterface {
  name = 'Migrations1744905429582';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tiktok_accounts" DROP COLUMN "tiktokUserId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiktok_accounts" DROP COLUMN "username"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tiktok_accounts" ADD "openId" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tiktok_accounts" DROP COLUMN "openId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "linkedin_metrics" ADD "tenantId" character varying NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "tiktok_accounts" ADD "username" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiktok_accounts" ADD "tiktokUserId" character varying NOT NULL`,
    );
  }
}
