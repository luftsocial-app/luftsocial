...
export class Migrations1743755381789 implements MigrationInterface {
  name = 'Migrations1743755381789';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "post_assets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "fileKey" character varying NOT NULL, "fileType" character varying NOT NULL, "uploadedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ed08ca38aaa5e342de73e419b33" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tbl_user_roles" ("role_id" character varying NOT NULL, "user_id" integer NOT NULL, CONSTRAINT "PK_8fe07cf638d5a10cbbadf9d1acd" PRIMARY KEY ("role_id", "user_id"))`,
    );
    await queryRunner.query(
