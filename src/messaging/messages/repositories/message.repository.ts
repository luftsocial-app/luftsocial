...
export class MessageRepository extends Repository<MessageEntity> {
  ...
  async findByIdAndTenant(
    ...
    try {
      ...
      this.logger.error(
        `Error finding message by ID and tenant: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async findMessageHistory(userId: string): Promise<MessageEntity[]> {
    try {
      ...
      this.logger.error(
        `Error finding message history: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async findThreadReplies(parentMessageId: string): Promise<MessageEntity[]> {
    try {
      ...
      this.logger.error(
        `Error finding thread replies: ${error.message}`,
        error.stack,
      );
      throw error;
    }
  ...
  async markAsDeleted(id: string, userId: string): Promise<void> {
    try {
      ...
      this.logger.error(
        `Error marking message as deleted: ${error.message}`,
        error.stack,
      );
      throw error;
    }
