...
describe('MessageController', () => {
  ...
  const mockMessageResponseInstance = createMockMessageResponse(
    mockMessageId,
    'Test message',
    mockAuthUser.userId,
  );
  ...
  describe('createMessage', () => {
    ...
    it('should create a message', async () => {
      messageServiceMock.createMessage.mockResolvedValue(
        mockMessageResponseInstance as MessageEntity,
      );
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(controller.createMessage(mockAuthUser, dto)).rejects.toThrow(
        BadRequestException,
      );
    });
  });
  ...
  describe('getMessages', () => {
    ...
    const messageListResponse: MessageListResponseDto = {
      messages: [mockMessageResponseInstance],
      total: 1,
      page: 1,
      limit: 10,
      unreadCount: 0,
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.getMessages(mockConversationId, queryWithUser, mockAuthUser),
  ...
  describe('getMessageHistory', () => {
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.getMessageHistory(mockAuthUser, mockMessageId),
  ...
  describe('getMessageById', () => {
    it('should get a message by ID', async () => {
      messageServiceMock.findMessageById.mockResolvedValue(
        mockMessageWithRelationsInstance as MessageEntity,
      );
      const result = await controller.getMessageById(
        mockAuthUser,
        mockMessageId,
      );
      ...
      expect(messageServiceMock.findMessageById).toHaveBeenCalledWith(
        mockMessageId,
      );
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.getMessageById(mockAuthUser, mockMessageId),
      ).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('updateMessage', () => {
    ...
    it('should update a message', async () => {
      messageServiceMock.updateMessage.mockResolvedValue(
        mockMessageResponseInstance as MessageEntity,
      );
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.updateMessage(mockAuthUser, mockMessageId, dto),
      ).rejects.toThrow(ForbiddenException);
    });
  });
  ...
  describe('deleteMessage', () => {
    it('should delete a message', async () => {
      ...
      expect(messageServiceMock.deleteMessage).toHaveBeenCalledWith(
        mockMessageId,
        mockAuthUser.userId,
      );
    });
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.deleteMessage(mockAuthUser, mockMessageId),
      ).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('addReaction', () => {
    ...
    it('should add a reaction', async () => {
      messageServiceMock.addReaction.mockResolvedValue(
        mockMessageResponseInstance as MessageEntity,
      );
      ...
      expect(messageServiceMock.addReaction).toHaveBeenCalledWith(
        mockMessageId,
        mockAuthUser.userId,
        dto.emoji,
      );
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.addReaction(mockAuthUser, mockMessageId, dto),
  ...
  describe('removeReaction', () => {
    ...
    it('should remove a reaction', async () => {
      messageServiceMock.removeReaction.mockResolvedValue(
        mockMessageResponseInstance as MessageEntity,
      );
      ...
      expect(messageServiceMock.removeReaction).toHaveBeenCalledWith(
        mockMessageId,
        mockAuthUser.userId,
        dto.emoji,
      );
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.removeReaction(mockAuthUser, mockMessageId, dto),
      ).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('getAttachmentsByMessageId', () => {
    it('should get attachments for a message', async () => {
      ...
      messageServiceMock.getAttachments.mockResolvedValue(
        attachments as AttachmentEntity[],
      );
      const result = await controller.getAttachmentsByMessageId(mockMessageId);
      expect(messageServiceMock.getAttachments).toHaveBeenCalledWith(
        mockMessageId,
      );
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.getAttachmentsByMessageId(mockMessageId),
      ).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('getThreadReplies', () => {
    ...
    it('should get thread replies', async () => {
      ...
      messageServiceMock.getThreadReplies.mockResolvedValue(
        replies as MessageEntity[],
      );
      ...
      expect(messageServiceMock.getThreadReplies).toHaveBeenCalledWith(
        mockMessageId,
        query,
      );
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.getThreadReplies(mockMessageId, query),
      ).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('markAsRead', () => {
    it('should mark a message as read', async () => {
      ...
      expect(messageServiceMock.markMessageAsRead).toHaveBeenCalledWith(
        mockMessageId,
        mockAuthUser.userId,
      );
    });
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.markAsRead(mockAuthUser, mockMessageId),
      ).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('getUnreadMessagesCount', () => {
    it('should get unread messages count', async () => {
      ...
      expect(messageServiceMock.getUnreadCount).toHaveBeenCalledWith(
        mockConversationId,
        mockAuthUser.userId,
      );
    ...
    it('should propagate error from service', async () => {
      ...
      await expect(
        controller.getUnreadMessagesCount(mockAuthUser, mockConversationId),
      ).rejects.toThrow(ForbiddenException);
    });
  });
});
